...
rds_name = os.environ['KUBERDS'] #variavel de ambiente
lb_dns_name = os.environ['KUBELB'] #variavel de ambiente
user = os.environ['KUBEUSER'] #variavel de ambiente
password = os.environ['KUBEPASS'] #variavel de ambiente
...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://"+user+":"+password+"@"+rds_name+"/catalogo_db"
